...
challengeType: Integer, defined in `client/utils/challenge-types.ts`
...
1. [Challenge types](https://github.com/freeCodeCamp/freeCodeCamp/blob/main/client/utils/challenge-types.ts#L1-L13) - what the numeric challenge type values mean (enum).
